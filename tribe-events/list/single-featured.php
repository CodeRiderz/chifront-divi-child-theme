...
<div class="tribe-events-list-event-description tribe-events-content">
	...
	<a href="<?php echo (empty(tribe_get_event_website_url()) ? esc_url( tribe_get_event_link()) : tribe_get_event_website_url() ); ?>" class="tribe-events-read-more" rel="bookmark"><?php esc_html_e( 'Find out more', 'the-events-calendar' ) ?> &raquo;</a>
